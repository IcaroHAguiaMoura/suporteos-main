...
public class ProdutoDTO {
    ...
    @NotNull(message = "O campo valorEstoque nao pode ser nulo")
    ...
    public @NotNull(message = "O campo valorEstoque nao pode ser nulo") @Digits(integer = 15, fraction = 2) BigDecimal getValorEstoque() {
        return valorEstoque;
    }

    public void setValorEstoque(@NotNull(message = "O campo valorEstoque nao pode ser nulo") @Digits(integer = 15, fraction = 2) BigDecimal valorEstoque) {
